...
// ========== SPAWN ENEMY DENGAN UKURAN MANUAL PER MUSUH ==========
function spawnEnemy() {
    // Ambil semua jenis musuh yang tersedia
    const enemyTypesList = [
        ...
        { 
            ...
            speedBonus: 1, 
            points: 15,
            customWidth: 200,     // UKURAN YANG DIINGINKAN
            customHeight: 160     // UKURAN YANG DIINGINKAN
        },
        { 
            name: 'POLANTAS', 
    ...
    // Gunakan lebar manual, tinggi mengikuti proporsi asli gambar
    ...
    // ========== BATASAN UKURAN (KHUSUS UNTUK MARINIR TIDAK DIBATASI) ==========
    const maxWidth = canvasWidth * 0.15;
    const minWidth = canvasWidth * 0.07;
    
    // MARINIR tidak dibatasi (biar besar sesuai customWidth)
    ...
    // MARINIR tetap pakai ukuran asli (120px atau sesuai keinginan)
    ...
    enemies.push({
        ...
        function spawnObstacle() {
            ...
            const dims = getImageDimensions(stoneImg, Math.min(80, canvasWidth * 0.08));
